...
\form{i, \ell := 1, 0, 1;\ \ENVP : [inv,\, post]}
\ENDDERIVE
...
The first conjunct is intuitively $\true$, as the maximal run of an array of $\LEN = 1$ is itself. The \textbf{LHS} of the implication is $true$ when $p = 0$ and $q = 1$
