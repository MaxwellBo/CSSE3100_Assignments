...
\end{eqnarray*}
% TODO: Should this last line have ANDs because of the spec?}
...
& \equiv & TODO
\end{eqnarray*}
% TODO: Does a \land b \entails a \land c \equiv b \entails c
...
i, j, k, r := 0, 0, 0, 0;\\
\Do~ \GUARD \rightarrow\\
    \t1 i, j, k, r, D:[inv\, \land\, \GUARD,~ inv\, \land\, (0 \leqslant V < V_0)]\\
\Od\\
\end{array}}
\ENDDERIVE
