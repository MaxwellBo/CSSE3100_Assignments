...
\begin{eqnarray*}
implicit\_bounds(i, j, k) & \triangleq & \BOUNDEDNONINCLUSIVE{i}{j}{k}
\end{eqnarray*}
...
\begin{eqnarray*}
&& (G_{union}(i, j, k) ~\land~ implicit\_bounds(i, j, k))[i, j, k, l \backslash, 0, A.len, 0, 0]\\
& \equiv &\\
&& G_{union}(i, j, k)[i, j, k, l \backslash, 0, A.len, 0, 0] ~\land~ implicit\_bounds(i, j, k)[i, j, k, l \backslash, 0, A.len, 0, 0]\\
\end{eqnarray*}
